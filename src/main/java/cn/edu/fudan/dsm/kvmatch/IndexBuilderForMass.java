...
public class IndexBuilderForMass {

    private static final Logger logger = LoggerFactory.getLogger(IndexBuilderForMass.class.getName());
...
//    private static final boolean[] WuEnabled = {true, true, false, true, false, false, false, true, false, false, false, false, false, false, false, true};
    ...
    public IndexBuilderForMass(int n) throws IOException {
        this.n = n;
    ...
    public static void main(String args[]) throws IOException {
        ...
        IndexBuilderForMass indexBuilder = new IndexBuilderForMass(n);
